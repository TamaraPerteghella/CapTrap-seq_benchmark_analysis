...
echo -e "seqTech\tcapDesign\tsizeFrac\tsampleRep\terrorCategory\terrorRate" > human.drna.sequencingError.stats.tsv
...
do
    ...
    sort ${lab}_${cap}_${tmp}_${sample}.sequencingError.stats.tsv >> human.drna.ntCoverageByGenomePartition.tsv
done  < ../samples.benchmark.supplementary.human.tsv
