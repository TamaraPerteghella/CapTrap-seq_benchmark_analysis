...
echo -e "seqTech\tcapDesign\tsizeFrac\tsampleRep\terrorCategory\terrorRate" > technology.sequencingError.stats.tsv
...
do
    ...
    sort ${lab}_${cap}_${tmp}_${sample}.sequencingError.stats.tsv >> technology.sequencingError.stats.tsv
