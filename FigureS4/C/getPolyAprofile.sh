...
done < ../../Figure3/samples.benchmark.technologies.tsv > captrap.polyAsites+polyAreads.stats.all.tmp.tsv
...
do
    ...
    echo -e "$name\t$polyAread\tpolyAread\n$name\t$common\tcommon\n$name\t$polyAsites\tpolyAsites"
done < ../../Figure3/samples.benchmark.technologies.tsv > captrap.polyAsites+polyAreads.stats.spliced.tmp.tsv
